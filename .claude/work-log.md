...
--- status ---
 ...
 M src/pages/admin/logistics/[id]/index.tsx
 M src/types/logistics/logistics.types.ts
?? .claude/
?? CLAUDE.md
?? src/components/containers/logistics/logistics-view-detail/
?? src/shared/api/mutations/logistics/
?? src/shared/api/query-hooks/
?? src/shared/api/querys/logistics/find-one-package-query.ts
...
93c3d32 Etapa 3: billing React Query hooks  queries y mutations
2ec6aca Etapa 2: billing API handler  GET list/detail/pending + PATCH mark-paid
6782647 Etapa 1: billing backend core  repo, service, types
--- status ---
...
--- status ---
 M .claude/docs/status.md
 M .claude/work-log.md
 D scripts/001-delivery-fees-settings.sql
 D scripts/002-billing-delivery-columns.sql
...
--- status ---
 ...
 M src/types/logistics/logistics.types.ts
?? src/components/containers/consolidations/
?? src/pages/admin/consolidations/
?? src/pages/api/consolidations/
?? src/shared/api/mutations/consolidations/
